...
const isLoading = true;
  ...
  return (
    ...
    <div className=" grid grid-rows-[1fr,min-content] justify-center h-[calc(100vh_-_74px)]  w-full text-center ">
      ...
      <article className=" overflow-auto text-left p-6 h-full max-w-4xl w-full">
        {!showResult ? (
          ...
          <div className=" place-content-start grow items-center  gap-7 w-full">
          ...
          <div>
          <div className="opacity-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit eligendi corporis aut nam iusto minima voluptatibus obcaecati eaque laboriosam illum, qui dolores sapiente dignissimos quam rem nulla neque repellat possimus.</div>
          <div className="flex items-start space-x-4 w-full">
           
           <img src="/gemini.png" alt="Gemini" className="h-10 w-10" />
        
           <div className="text-gray-800 p-4 rounded-xl w-full  "  style={{ minWidth: "100px", maxWidth: "100%", overflowWrap: "break-word", wordWrap: "break-word" }}>
       
             {loading ? (
            
               <div className=" space-y-2 w-full h-full">
              
                 <hr className="w-full h-3 rounded-sm bg-gradient-to-r from-blue-600 via-blue-50 to-blue-300 bg-200% animate-gradientTranslate" />
                 <hr className="w-full h-3 rounded-sm bg-gradient-to-r from-blue-600 via-blue-50 to-blue-300 bg-200% animate-gradientTranslate" />
                 <hr className="w-2/3 h-3 rounded-sm bg-gradient-to-r from-blue-600 via-blue-50 to-blue-300 bg-200% animate-gradientTranslate" />
               </div>
             ) : (
               <p className="w-full" dangerouslySetInnerHTML={{ __html: resultData }} />
             )}
           </div>
         </div>
          </div>
